...
function Politics() {
  ...
  const apiUrl = "https://newsapi.org/v2/top-headlines?country=in&category=politics&apiKey=a300948ed62e4ad991d03b1e21f58a78";
  ...
  return (
    <div>
      <div className="politics">
        <h1 className="title">Politics News</h1>
        <div className="list">
